...
const Terms = () => (
  <Wrapper>
    ...
    <Text>
      By accessing the website at https://{import.meta.env.VITE_BASE}, you are agreeing to be bound
      ...
      <br />
      <br />
      In no event shall {import.meta.env.VITE_BASE} or its suppliers be liable for any damages
      ...
      materials on {import.meta.env.VITE_BASE}'s website, even if {import.meta.env.VITE_BASE} or a {import.meta.env.VITE_BASE} authorized
      ...
      <br />
      <br />
      The materials appearing on {import.meta.env.VITE_BASE} website could include technical,
      typographical, or photographic errors. {import.meta.env.VITE_BASE} does not warrant that any of
      the materials on its website are accurate, complete or current. {import.meta.env.VITE_BASE} may
      make changes to the materials contained on its website at any time without
      notice. However {import.meta.env.VITE_BASE} does not make any commitment to update the
      materials.
      <br />
      <br />
      {import.meta.env.VITE_BASE} has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any
      link does not imply endorsement by {import.meta.env.VITE_BASE} of the site. Use of any such
      linked website is at the user's own risk.
      <br />
      <br />
      {import.meta.env.VITE_BASE} may revise these terms of service for its website at any time
